...
// import laLogo from "../../public/images/png/laLogo";
import MainMenu from "./mainMenu";
import SwipeableSideDrawer from "./sideDrawer";
    ...
    <Box sx={{ flexGrow: 1 }} data-testid="appBarBox">
      <AppBar position="static">
        <Toolbar disableGutters sx={{ p: theme.spacing(0, 2) }}>
           <img src={'../../images/laLogo.png'} alt="Lord Abbett" height={32} /> 
          <Typography
            variant="h6"
            noWrap
            sx={{
          ...
          >
            NOOR UL ISLAM URDU HIGH SCHOOL
          </Typography>
